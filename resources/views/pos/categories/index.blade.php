    ...
    <div class="bg-white rounded-2 shadow-sm p-4 mb-4">
        <div class="row">
            <div class="d-grid d-lg-block col-lg-5 col-xl-6 mb-4 mb-lg-0">
                ...
                <a href="{{ route('pos.categories.create') }}" class="btn btn-primary py-2 px-3">
                    <i class="ti ti-plus me-2"></i> Add Category
                </a>
            </div>
            <div class="col-lg-7 col-xl-6">
                {{-- form pencarian --}}
                <form action="{{ route('pos.categories.index') }}" method="GET">
                    ...
                    @forelse ($categories as $category)
                        ...
                        <tr>
                            ...
                            <td width="70" class="text-center">
                                ...
                                <a href="{{ route('pos.categories.edit', $category->id) }}"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        {{-- button hapus data --}}
                                        <form action="{{ route('pos.categories.destroy', $category->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
