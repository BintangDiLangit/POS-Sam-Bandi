    ...
    <div class="bg-white rounded-2 shadow-sm p-4 mb-4">
        <div class="row">
            <div class="d-grid d-lg-block col-lg-5 col-xl-6 mb-4 mb-lg-0">
                ...
                <a href="{{ route('pos.customers.create') }}" class="btn btn-primary py-2 px-3">
                    <i class="ti ti-plus me-2"></i> Add Customer
                </a>
            </div>
            <div class="col-lg-7 col-xl-6">
                {{-- form pencarian --}}
                <form action="{{ route('pos.customers.index') }}" method="GET">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control form-search py-2"
                            value="{{ request('search') }}" placeholder="Search customer ..." autocomplete="off">
                    ...
                    @forelse ($customers as $customer)
                        ...
                        <tr>
                            ...
                            <td width="70" class="text-center">
                                ...
                                <a href="{{ route('pos.customers.edit', $customer->id) }}"
                                ...
                                <button type="button" class="btn btn-danger btn-sm m-1" data-bs-toggle="modal"
                                    data-bs-target="#modalDelete{{ $customer->id }}" data-bs-tooltip="tooltip"
                        ...
                        {{-- Modal hapus data --}}
                        <div class="modal fade" id="modalDelete{{ $customer->id }}" data-bs-backdrop="static"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p class="mb-2">
                                            Are you sure to delete <span
                                                class="fw-bold mb-2">{{ $customer->name }}</span>?
                                        </p>
                                    </div>
                                    <div class="modal-footer">
                                        ...
                                        {{-- button hapus data --}}
                                        <form action="{{ route('pos.customers.destroy', $customer->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger py-2 px-3"> Yes, delete it!
                                            </button>
                                        </form>
                                    </div>
                                </div>
