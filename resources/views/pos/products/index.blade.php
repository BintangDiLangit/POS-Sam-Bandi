    ...
    <div class="bg-white rounded-2 shadow-sm p-4 mb-4">
        <div class="row">
            <div class="d-grid d-lg-block col-lg-5 col-xl-6 mb-4 mb-lg-0">
                ...
                <a href="{{ route('pos.products.create') }}" class="btn btn-primary py-2 px-3">
                    <i class="ti ti-plus me-2"></i> Add Product
                </a>
            </div>
            <div class="col-lg-7 col-xl-6">
                {{-- form pencarian --}}
                <form action="{{ route('pos.products.index') }}" method="GET">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control form-search py-2"
                            value="{{ request('search') }}" placeholder="Search product ..." autocomplete="off">
                ...
                <tbody>
                    @forelse ($products as $product)
                        ...
                        <tr>
                            ...
                            <td width="80" class="text-end">{{ 'Rp ' . number_format($product->price, 0, '', '.') }}
                            </td>
                            <td width="140">{{ $product->category->name }}</td>
                            <td width="100" class="text-center">
                                {{-- button form detail data --}}
                                <a href="{{ route('pos.products.show', $product->id) }}"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        {{-- button hapus data --}}
                                        <form action="{{ route('pos.products.destroy', $product->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
