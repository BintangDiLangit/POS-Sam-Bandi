    ...
    <div class="bg-white rounded-2 shadow-sm p-4 mb-4">
        <div class="row">
            <div class="d-grid d-lg-block col-lg-5 col-xl-6 mb-4 mb-lg-0">
                ...
                <a href="{{ route('pos.transactions.create') }}" class="btn btn-primary py-2 px-3">
                    <i class="ti ti-plus me-2"></i> Add Transaction
                </a>
            </div>
            <div class="col-lg-7 col-xl-6">
                {{-- form pencarian --}}
                <form action="{{ route('pos.transactions.index') }}" method="GET">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control form-search py-2"
                            value="{{ request('search') }}" placeholder="Search transaction ..." autocomplete="off">
                    ...
                    @forelse ($transactions as $transaction)
                        ...
                        <tr>
                            ...
                            <td width="80" class="text-center">
                                ...
                                <a href="{{ route('pos.transactions.edit', $transaction->id) }}"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        {{-- button hapus data --}}
                                        <form action="{{ route('pos.transactions.destroy', $transaction->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
