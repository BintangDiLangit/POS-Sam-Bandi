<x-app-layout>
    ...
    <div class="bg-white rounded-2 shadow-sm p-4 mb-4">
        ...
        {{-- form filter data --}}
        <form action="{{ route('pos.report.filter') }}" method="GET" class="needs-validation" novalidate>
            <div class="row">
            ...
            <div class="d-flex flex-column flex-lg-row mb-4">
                <div class="flex-grow-1 d-flex align-items-center">
                    ...
                    <h6 class="mb-0">
                        ...
                        Transactions' data report on {{ date('F j, Y', strtotime(request('start_date'))) }} -
                        {{ date('F j, Y', strtotime(request('end_date'))) }}.
                    </h6>
                </div>
                <div class="d-grid gap-3 d-sm-flex mt-3 mt-lg-0">
                    {{-- button cetak laporan (export PDF) --}}
                    <a href="{{ route('pos.report.print', [request('start_date'), request('end_date')]) }}"
                        target="_blank" class="btn btn-warning py-2 px-3">
