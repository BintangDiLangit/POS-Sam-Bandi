...
<head>
    ...
    <meta name="description" content="Aplikasi POS Sam Bandi dengan Laravel 11">
        ...
        <div class="container">
            <div class="d-flex flex-column flex-md-row align-items-center align-items-md-left">
                ...
                <div class="copyright text-center mb-2 mb-md-0">
                    &copy; 2024 - <a href="https://sambandi.id/" target="_blank" class="fw-semibold">Pustaka
                        Koding</a>. All rights reserved.
                </div>
                {{-- link --}}
                <div class="link ms-md-auto">
                    <a href="https://sambandi.id/" target="_blank">Terms & Conditions</a>
                </div>
            </div>
        </div>
    </footer>
