...
class CustomerController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('pos.customers.index', compact('customers'))->with('i', ($request->input('page', 1) - 1) * $pagination);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $request->validate([
            ...
            'address' => 'nullable',
            'phone'   => 'nullable|max:13|unique:customers,phone',
        ...
        return redirect()->route('pos.customers.index')->with(['success' => 'The new customer has been saved.']);
    }
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        $request->validate([
            ...
            'address' => 'nullable',
            'phone'   => 'nullable|max:13|unique:customers,phone,' . $id,
        ...
        return redirect()->route('pos.customers.index')->with(['success' => 'The customer has been updated.']);
    }
    ...
    public function destroy($id): RedirectResponse
    {
        ...
        return redirect()->route('pos.customers.index')->with(['success' => 'The customer has been deleted!']);
    }
}
